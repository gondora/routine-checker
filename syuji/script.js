...
const routineData = {
  ...
  weekday: {
    ...
    evening: { label: "平日 / EVENING", questions: ["腕立て伏せはした？", "ウニの餌はやった？","洗い物はやった？", "風呂には入った？", "歯は磨いた？", "薬は飲んだ？", "ウニのシートはやった？", "ウニの水は交換した？", "靴は乾かした？"] },
  },
  // 休日（土・日）のリストz
  weekend: {
    morning: { label: "休日 / MORNING", questions: ["くすりは飲んだ？", "ウニの散歩","靴は乾かした？" ,"着替えはした？", "朝ごはんは食べた？", "歯磨きはした？", "顔は洗った？","洗濯物は畳んだ？","洗い物はやった？","爪は切った？"] },
    afternoon: { label: "休日 / AFTERNOON", questions: ["ウニの散歩にいった？", "ボンバー"] },
    evening: { label: "休日 / EVENING", questions: ["ウニの散歩にいった？", "腕立て伏せはした？", "うにのえさはやった？","洗い物はヤッタ？" ,"風呂には入った？", "歯は磨いた？", "薬は飲んだ？", "ウニのシートはやった？","ウニの水はやった？" ,"靴は乾かした？"] },
  },
};

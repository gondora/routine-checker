...
const routineData = {
  // 平日（月〜金）のリスト
  weekday: {
    morning: { label: "平日 / MORNING", questions: ["くすりは飲んだ？", "着替えはした？", "朝ごはんは食べた？", "歯磨きはした？", "顔は洗った？", "持ち物(給食セット)", "持ち物(手袋)", "持ち物(帽子)", "持ち物(鍵)", ""] },
    afternoon: { label: "平日 / AFTERNOON", questions: ["散歩にいった？", "靴は乾かした？", "宿題はやった？", "給食セットは出した？", "鉛筆は削った？", "学校から出た手紙は出した？", "洗い物はした？", "洗濯をたたんだ？", "タッチはやった？"] },
    evening: { label: "平日 / EVENING", questions: ["腕立て伏せはした？", "  ウニの餌はやった？", "風呂には入った？", "歯は磨いた？", "薬は飲んだ？", "ウニのシートはやった？", "ウニのシートはやった？", "靴は乾かした？"] },
  },
  // 休日（土・日）のリスト
  weekend: {
    morning: { label: "休日 / MORNING", questions: ["くすりは飲んだ？", "ウニの散歩", "着替えはした？", "朝ごはんは食べた？", "歯磨きはした？", "顔は洗った？"] },
    afternoon: { label: "休日 / AFTERNOON", questions: ["ボンバー"] },
    evening: { label: "休日 / EVENING", questions: ["腕立て伏せはした？", "ウニの散歩入った？", "うにのえさはやっった？", "風呂には入った？", "歯は磨いた？", "薬は飲んだ？", "ウニのシートはやった？", "靴は乾かした？"] },
  },
};
